...
public class BookingNegativePage {

	private WebDriver driver;
	private WebDriverWait wait;

	public BookingNegativePage(WebDriver driver) {
		this.driver = driver;
	...
	// Error locators
	private By nameError = By.xpath("//*[text()='name must contain more then 3 charater']");
	private By companyError = By.xpath("//*[text()='Please enter valid company name']");
	private By numberError = By.xpath("//*[text()='Invalid phone no*917666 false']");
	private By addressError = By.xpath("//*[text()='Please enter correct address']");
	...
	public void enteraddress(String add) {
		...
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("arguments[0].blur();", addressField);
	}
	...
	public String getnumberErrorMessage() {
		return driver.findElement(numberError).getText();
	}
